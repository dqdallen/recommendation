...
class WideAndDeep(nn.Module):
    def __init__(self,
        ...
        Args:
            ...
            emb_dims (list): the list of embedding dims
            encode_dim (int): encode dim
        ...
        self.predict = nn.Linear(self.emb_dims[-1], 1)
    ...
    def deep_layer(self):
        ...
        dlayers = nn.ModuleList([nn.BatchNorm1d(input_dim), nn.Linear(
            input_dim, self.emb_dims[0]), nn.PReLU()])
    ...
    def forward(self, features):
        ...
        wide_emb = torch.cat(
            [item_emb, item_his_emb, item_emb * item_his_emb], 1)
